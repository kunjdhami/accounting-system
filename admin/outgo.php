...
<!--
<form method="post" action="outgo.php" enctype="multipart/form-data">
...
<div class="container">
    <form method="post" action="outgo.php" enctype="multipart/form-data">
        ...
        <div class="form-group row justify-content-sm-center">
            ...
            <input type="text" name="issue" class="form-control" id="inputPassword3" placeholder="Enter issue like affi/karar">
            </div>
        </div>
        <div class="form-group row justify-content-sm-center">
        ...
        <div class="form-group row justify-content-sm-center">
            ...
            <div class="col-sm-3 ml-2">
            <input type="date" name="date" class="form-control" id="inputPassword3" placeholder="Enter date">
            </div>
        </div>
        <div class="form-group row justify-content-sm-center">
            ...
            <div class="col-sm-3 ml-2">
            <input type="text" name="conno" class="form-control" id="inputPassword3" placeholder="Enter mobile no">
            </div>
        ...
        <div class="form-group row justify-content-sm-center">
            ...
            <div class="col-sm-3 ml-2">
            <input type="text" name="amount" class="form-control" id="inputPassword3" placeholder="Enter amount">
            </div>
        </div>
        <div class="form-group row justify-content-sm-center">
